-- tickets - id, seats
-- person table - first/last name maybe
-- location table - city/country
-- airline table - departure/arrival

-- many(airlines) to many(locations)
  -- join airport
    -- one airline to many airports to one location
-- one(person) to one(ticket)
-- many(tickets) to one (airlines)
